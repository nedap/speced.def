(ns unit.nedap.speced.def.defprotocol
  ...
  (:require
   ...
   [nedap.speced.def.impl.defprotocol :as impl.defprotocol]))
   ...
   (deftest primitive-type-hints
     (testing "Primitive hints is forbidden"
       (are [input] (try
         ...
         '(nedap.speced.def/defprotocol primitive-type-hints-A "Doc" (aaa-it [this, ^long x] "Doc"))
         '(nedap.speced.def/defprotocol primitive-type-hints-B "Doc" (bbb-it ^long [this x] "Doc"))
         '(nedap.speced.def/defprotocol primitive-type-hints-C "Doc" (^long ccc-it [this x] "Doc"))))))
