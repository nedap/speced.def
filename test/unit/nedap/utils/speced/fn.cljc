(ns unit.nedap.utils.speced.fn
  ...
  #?(:cljs (:require-macros [unit.nedap.utils.speced.fn :refer [the-fns]])))
                                                  ...
                                                  [{:keys [age temperature length name cool?]} p__196417]
                                                   (clojure.core/assert
                                                    (nedap.utils.spec.api/check!
                                                     ...
                                                     :unit.nedap.utils.speced.fn/age
                                                     age

                                                     :unit.nedap.utils.speced.fn/temperature
                                                     temperature
